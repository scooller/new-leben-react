      ...
      <div className="card lb-proj-det-agent-card h-100">
        <div className="card-body row align-items-center gap-3">
          ...
          <div className="d-flex flex-column col-12 col-md">
            ...
            <button
              className="btn btn-outline-dark btn-sm mt-2 d-inline-flex align-items-center justify-content-center gap-2"
              onClick={() => setShowModal(true)}
              {...hover(calendarRef)}
            >
              <CalendarCheckIcon ref={calendarRef} size={16} /> Agendar cita
            </button>
          </div>
        </div>
      </div>
